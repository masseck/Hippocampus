...
Postprocessing script for channel-level MUA firing rates (displayed as Gardner-Altman plots) based on the
summary output of process_spikes_psth.py. Only Baseline vs. Full stimulation plots are shown in the manuscript.

Creates paired mean-difference plots for:
- Baseline vs Early stimulation (first third of stimulation (exploratory))
- Baseline vs Late stimulation (last third of stimulation (exploratory))
- Baseline vs Full stimulation (used in the paper)

Early and late are included for completeness but not reported in the paper.
...
--------------------
For cohorts where the recording protocol differed (i.e. ChR2 animals with
...
# Settings
# -----------------------------
export_path_base = r"C:\Users\Juliana\Documents\_PhD\Data\_Processed"
